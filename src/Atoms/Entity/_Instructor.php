...
/**
 * @method static \Application\Atoms\EntityFinder\_Instructor search( Filter $filter = null )
 * #[Immutable( 'guid', true )]
 ...
 * @method static \Atomino\Carbon\Database\Finder\Comparison is_instructor($isin = null)
 * @method static \Atomino\Carbon\Database\Finder\Comparison is_lecturer($isin = null)
...
#[Immutable("id",false)]
#[Field("is_instructor", \Atomino\Carbon\Field\BoolField::class)]
#[Field("is_lecturer", \Atomino\Carbon\Field\BoolField::class)]
...
abstract class _Instructor extends Entity {
	...
	const is_instructor = 'is_instructor';
	public bool|null $is_instructor = null;
	const is_lecturer = 'is_lecturer';
	public bool|null $is_lecturer = null;
	const lang = 'lang';
